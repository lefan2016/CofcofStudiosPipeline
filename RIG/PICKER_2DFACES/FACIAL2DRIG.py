...
win = cmds.window('win2dFacialRig', title="2D Facial Rig! v1.0" , menuBar=0 , w=400 , s=1 , height= 100, bgc=(0.2,0.2,0.2) , resizeToFitChildren=1 )
#location_locators = createInitialLocators(sel)
col1 = cmds.columnLayout( columnAttach=('left', 5), adjustableColumn=True , rowSpacing=10, cal= "center" , columnWidth=100 , p=win , bgc=(0.15,0.15,0.15)  )
cmds.button('Selecciona el mesh de la cabeza y clickeame.',p=col1,c=validateInitLocButtCmd , w=400)
...
c1 =   cmds.columnLayout( columnAttach=('left', 5), adjustableColumn=True , rowSpacing=10,  cal= "center", columnWidth=550 , p=win , bgc=(0.2,0.2,0.2) )
...
cmds.button( label = 'Crear Locator.' , command = 'cmds.spaceLocator(n="scaleReference_LOC")' , p = r0 )
c2 =   cmds.columnLayout( columnAttach=('left', 5) , adjustableColumn=True , rowSpacing=10,  cal= "center", columnWidth=550 , p=win , bgc=(0.2,0.2,0.2) )
c2 = cmds.columnLayout( columnAttach=('left', 5), rowSpacing=10, columnWidth=550 , p=win , bgc=(0.25,0.25,0.25) )
cmds.text('Selecciona el scaleReference_LOC , el mesh de la cabeza y el controlador de la cabeza.',p=c2)
r1 = cmds.rowLayout( numberOfColumns=2, columnWidth2=(200, 200), adjustableColumn=1, columnAlign=(1, 'right'), columnAttach=[(1, 'both', 0), (2, 'both', 0)])
